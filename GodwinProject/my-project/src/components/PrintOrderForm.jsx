...
PrintOrderForm.propTypes = {
  printOrder: PropTypes.object.isRequired,
...
export default function PrintOrderForm({ workOrder, updateWorkOrder, formMode, submitCallback, cancelCallback }) {
  ...
  // In this version, the PrintOrders component needs access to the state so it can initialize the
      ...
      <div className="form-group">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" autoComplete='custID' name="custID" id="custID"
            placeholder="Customer Name" value={workOrder.custID} onChange={(event) => updateWorkOrder('custID', event.target.value)} />
        </div>
